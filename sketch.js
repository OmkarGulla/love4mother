  ...
  if(gameState === PLAY){
    ...
    //adding gravity
     boy.velocityY = boy.velocityY + 2;
         ...
         //make hot air baloon stop on the ground
...
if(topObstaclesGroup.isTouching(boy) || boy.isTouching(topGround)
 || bottomObstaclesGroup.isTouching(boy)){
